...
What goes into the AI and what comes back out on every message. All calls go through OpenRouter (`openrouter.ai/api/v1/chat/completions`) using the model configured in `CLAUDE_MODEL`.
